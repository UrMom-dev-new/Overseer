/**
 * OVERSEER Intelligence Layer — overseer-intel
 *
...
const WIKIDATA_UA = 'OVERSEER-Intel/1.0 (https://overseerai.live; ontology engine)';
...
app.get('/resolve', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      links: result.links,
      entity: { type, id },
      source: 'OVERSEER Intelligence Layer',
...
async function boot() {
  console.log('[INTEL] OVERSEER Intelligence Layer starting...');
  await loadSanctions();
