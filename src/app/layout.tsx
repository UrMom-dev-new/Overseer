...
const SITE_URL = "https://overseerai.live";
const SITE_NAME = "OVERSEER";
const SITE_TITLE = "OVERSEER — Open Source Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | OVERSEER Intelligence",
  },
  ...
  keywords: [
    ...
    // Brand
    "overseer", "overseerai", "overseerai.live",
  ],
  authors: [{ name: "Overseer Project", url: SITE_URL }],
  creator: "Overseer Project",
  publisher: "Overseer Project",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "OVERSEER — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "OVERSEER — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "OVERSEER",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "OVERSEER — OSINT Toolkit & Intelligence Platform",
  alternateName: ["OVERSEER", "OverseerAI", "Overseer OSINT"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name="OVERSEER Core">
          {children}
        </ErrorBoundary>
      </body>
    </html>
