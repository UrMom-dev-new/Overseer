...
if(scenario === 'never-ready') setInterval(()=>{},1000);
 ...
 server.listen(0,'127.0.0.1',()=>{
  ...
  writeFileSync(join(folder,'overseer-desktop.log'),[
   {message:'Local server listening on http://127.0.0.1:'+server.address().port},
   {message:'dashboard interactive: Dashboard main frame loaded.'}
